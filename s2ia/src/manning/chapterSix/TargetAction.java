 ...
 * tag for purposes of demonstration.1
 */
...
public class TargetAction extends ActionSupport implements RequestAware 
{
	public String execute() throws Exception{
		...
		/* put some data into the request scope so that it can be accessed
	...
	/* JavaBeans property that will recieve the map of request
	 * attributes via the RequestAware interface.
	 */
	private Map request;
